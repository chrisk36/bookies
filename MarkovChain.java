...
//        }
//
//        bigramFrequencies.computeIfAbsent(first, k ->
//                new ProbabilityDistribution<>()).record(second);
//    }
//
//    /**
...
//        } else if (tweet.hasNext()) {
//            String current = tweet.next();
//
//            if (!current.isEmpty()) {
//                startTokens.record(current);
//            }
//
//            while (tweet.hasNext()) {
