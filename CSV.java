...
public class CSV {
    ...
    public static List<String> parseRecord(String csvLine) {
        if (csvLine == null) {
            throw new IllegalArgumentException("csvLine cannot be null");
        }
    ...
    static String extractColumn(String csvLine, int csvColumn) {
        ...
        if (csvColumn < 0 || csvColumn >= fields.size()) {
            throw new IndexOutOfBoundsException("csvColumn out of bounds");
        }
    ...
    static List<String> csvFieldsAtColumn(BufferedReader br, int csvColumn) {
        if (br == null) {
            throw new IllegalArgumentException("br cannot be null");
        }
        ...
        try {
            while ((line = br.readLine()) != null) {
                try {
                    String field = extractColumn(line, csvColumn);
